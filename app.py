    ...
    <article id="{safe_id}" class="{card_class}">
        ...
        <div class="highlight-body">
            ...
            <div class="actions">
                ...
                <div class="share-row">
                    <button class="share-btn" type="button" onclick="shareNews('{safe_js_title}', '{safe_id}')" aria-label="Compartilhar notícia" title="Compartilhar">
...
.open-link{{font-size:.9rem;font-weight:800;color:var(--navy-mid);}}
...
async function shareNews(title,id){{
